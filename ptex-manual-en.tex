...
In \pTeX/\upTeX,
some additional DVI commands that is defined in the standard \cite{dvistd0}
but never used in \TeX82 are used.
\begin{itemize}
  \item |set2| (129), |put2| (134):
    Appears in both \pTeX\ and \upTeX\ DVI.
    Used to typeset a Japanese character with 2-byte code. 
  \item |set3| (130), |put3| (135): Appears in only \upTeX\ DVI.
...
\pTeX\ and \upTeX\ have exactly the same number of registers
as Knuthian \TeX.
...
Here we provide only complete lists of additional primitives of \pTeX\ family.

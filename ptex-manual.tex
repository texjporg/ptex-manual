...
\csitem[\.{jcharwidowpenalty}=<number>]
  パラグラフの最後の和文文字が孤立して行分割されるのを防ぐための
  ペナルティを設定する．
% [TODO] アスキーのサイトに従うと
%% またパラグラフの最後に1文字以上の1区，2区に
%% 含まれる文字がある場合は，その直前にある2バイトコードに対して
%% このペナルティが使われる．
% となりそうだが，jtexdoc.tex に従うと
%% またパラグラフの最後が1文字以上の1区，2区，7区に
%% 含まれる文字の場合は，その直前にある全角文字に対して
%% このペナルティが使われる．
% となりそうで，微妙に違う…？
\end{cslist}

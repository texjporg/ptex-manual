...
各種類あたり$16\cdot 32768=524288$個まで使えるとは思うが，これはきりが悪い）．
そこで，\epTeX では\eTeX 流の方法を用いながらも，レジスタ(count, dimen,
skip, muskip, box, token)をさらに65536個まで増やしている．

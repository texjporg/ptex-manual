...
\AtBeginDvi{%
  \special{pdf:mapline hgothb-h        H       HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline hgothb-v        V       HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-cjgb-h      Identity-H      HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-cjgb-v      Identity-V      HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-ujgb-h      UniJIS-UTF16-H  HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-ujgb-v      UniJIS-UTF16-V  HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline hgothr-h        H       HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline hgothr-v        V       HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-cjgr-h      Identity-H      HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-cjgr-v      Identity-V      HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-ujgr-h      UniJIS-UTF16-H  HaranoAjiGothic-Medium.otf}
  \special{pdf:mapline otf-ujgr-v      UniJIS-UTF16-V  HaranoAjiGothic-Medium.otf}
}
...
\]
      ...
      処理している．
      % なお，LuaTeX にも無限のレベル fi が存在するが，
      % \gluestretchorder, \glueshrinkorder は e-(p)TeX と異なり
      % 有限-fi-fil-fill-filll で 0-1-2-3-4 である．
      % e-TeX 互換の \eTeXgluestretchorder, \eTeXglueshrinkorder が
      % r52360 で追加され，そちらは 有限-fil-fill-fill で 0-1-2-3 とし，fi は -1 である．
\end{itemize}
